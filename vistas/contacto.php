...
<div class="container bootstrap snippets">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form role="form" name="" id="" action="" method="post" class="form-main">

            <div class="form-group">
              <label for="name2">Nombre Completo</label>
              <input class="form-control" id="name2" name="name" type="text" placeholder="Escribe tu nombre completo">
            </div>
            <div class="form-group">
              <label for="name2">Teléfono</label>
              <input class="form-control" id="name2" name="name" type="text" placeholder="Escribe tu número teléfonico">
            </div>  

            <div class="form-group">
              <label for="email2">Correo</label>
              <input class="form-control" id="email2" name="email" type="email" placeholder="Escribe tu correo eléctronico">
            </div> 

            <div class="form-group">
              <label for="message2">Comentario</label>
              <textarea class="form-control" id="message2" name="message" rows="5" placeholder="Escribe tu comentario"></textarea>
            </div>

            <div class="row">            
              <div class="col-xs-12">
                <button type="submit" class="btn btn-warning btn-shadow btn-rounded w-md" id="send">ENVIAR</button>
              </div>
            </div>
